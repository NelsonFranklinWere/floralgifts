...
export default async function ReviewsSection() {
  ...
  console.log('ReviewsSection - Config:', config);
  console.log('ReviewsSection - Place ID:', config.GOOGLE_PLACE_ID);
...
=======
    <section className="py-16 bg-[#FAF7F2]">
      ...
      <div className="text-center mt-10 px-4">
        <a
          href={`https://search.google.com/local/writereview?placeid=${config.GOOGLE_PLACE_ID}`}
          target="_blank"
