          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 rounded-full bg-white/10 hover:bg-brand-red flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/10 hover:bg-black flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-lg"
        ...
        <div className="border-t border-white/10 mt-6 pt-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-6 text-sm">
              ...
              <Link href="/terms" className="text-brand-gray-400 hover:text-brand-red transition-colors">
                Terms of Service
              </Link>
              <Link href="/returns" className="text-brand-gray-400 hover:text-brand-red transition-colors">
                Returns
              </Link>
            </div>
          </div>
