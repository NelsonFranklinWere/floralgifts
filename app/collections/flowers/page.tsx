...
export const metadata: Metadata = {
  title: "Flowers Nairobi | Money Bouquet, Romantic Flowers & Surprise Gifts for Wife | Flower Delivery Nairobi",
  description:
    "Premium flowers Nairobi: money bouquet, romantic flowers, surprise gifts for your wife. Same-day flower delivery across Nairobi CBD, Westlands, Karen, Lavington, Kilimani. Roses, bouquets, money flower arrangements. Order flowers online with M-Pesa. Fast flower delivery Nairobi.",
  keywords: [
    ...
    "flowers for my wife Nairobi",
    "flowers for my love Nairobi",
    "best flowers for wife Nairobi",
    "romantic gift flowers Nairobi",
    ...
    "new year gift flowers Nairobi",
    "flowers for couples Nairobi",
    "gift flowers Nairobi",
  ],
  alternates: {
    canonical: `${baseUrl}/collections/flowers`,
  },
  openGraph: {
    title: "Flowers Nairobi | Money Bouquet, Romantic Flowers & Surprise Gifts for Wife",
    description: "Premium flowers Nairobi: money bouquet, romantic flowers, surprise gifts for your wife. Same-day flower delivery across Nairobi CBD, Westlands, Karen, Lavington, Kilimani.",
  ...
  twitter: {
    ...
    title: "Flowers Nairobi | Money Bouquet, Romantic Flowers & Surprise Gifts for Wife",
    description: "Premium flowers Nairobi: money bouquet, romantic flowers, surprise gifts for your wife. Same-day flower delivery across Nairobi.",
  },
};
